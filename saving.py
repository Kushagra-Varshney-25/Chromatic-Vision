...
def save_fig(pred, ab, Ls, epoch, show):
    ...
    if not os.path.isdir('./predictions/visualization_L1loss_final/'):
        os.mkdir('./predictions/visualization_L1loss_final/')
    fig.savefig("./predictions/visualization_L1loss_final/{}.png".format(epoch+1))
